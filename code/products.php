...
<html>
    ...
    <body>
        <div>
            ...
            <div class="container">
                <div class="jumbotron">
                    <h1>Welcome to our A(rtificial) Coffee Shop!</h1>
                    <p>We have the best Coffee's, Deserts and Spicy eatables for you. No need to hunt around, we have all in one place.</p>
                </div>
            </div>
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/double-espresso.jpg" alt="double-espresso">
                            </a>
                            <center>
                                <div class="caption">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/caramelhotchoc.jpg" alt="caramelhotchoc">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Caramel Hot Chocolate</h3>
                                    <p>Price: Rs. 135.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/pumpkinpie.jpg" alt="pumpkinpie">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Pumpkin Pie</h3>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/frenchfries.jpg" alt="frenchfries">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>French Fries</h3>
